...
$virtualDiskPath = "c:\Images\Server_2008_R2_Enterprise.qcow2"
# This is the content of your Windows ISO
$wimFilePath = "C:\Repo\OS\WinSvr2008R2_RPC\OEM\sources\install.wim"
...
New-WindowsCloudImage -WimFilePath $wimFilePath -ImageName "Windows Server 2008 R2 SERVERENTERPRISE" `
